...
<head>
    <meta charset="UTF-8">
    <title>Manage Announcements - SRMS Faculty</title>
    ...
    <div class="app-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-item">
                    <a href="${pageContext.request.contextPath}/faculty/announcements" class="sidebar-link active">
        ...
        <div class="main-wrapper">
            <div class="top-navbar">
                <div class="page-title">Faculty Announcements Management</div>
                <div class="user-profile-badge">
                    <div class="user-avatar">F</div>
                    <div class="user-info">
                        <span class="user-name">${faculty.name}</span>
                        <span class="user-role">${faculty.designation}</span>
                    </div>
                    <a href="${pageContext.request.contextPath}/logout" class="btn btn-outline btn-sm ms-3">Logout</a>
                </div>
            </div>
            ...
            <div class="content-body">
                ...
                <c:if test="${not empty param.error}">
                    <div class="alert alert-danger"><i class="bi bi-exclamation-triangle"></i> ${param.error}</div>
                </c:if>

                <!-- Post Announcement Form -->
                <div class="card mb-4">
                    <div style="font-weight: 600; font-size: 1.1rem; margin-bottom: 1rem;"><i class="bi bi-megaphone me-1"></i> Post New Faculty Notice / Announcement</div>
                    <form action="${pageContext.request.contextPath}/faculty/announcements" method="post">
                        <div class="form-group">
                            <label>Announcement Title</label>
                            <input type="text" name="title" class="form-control" placeholder="e.g. Extra Class / Lab Schedule Change" required>
                        </div>
                        <div class="form-group">
                            <label>Detailed Message</label>
                            <textarea name="message" class="form-control" rows="4" placeholder="Enter details of your announcement..." required></textarea>
                        </div>
                ...
                <!-- Announcements Feed -->
                <div class="card">
                    <div style="font-weight: 600; font-size: 1.1rem; margin-bottom: 1rem;"><i class="bi bi-broadcast me-1"></i> Announcements History & Edit</div>
                        ...
                        <div style="border-left: 4px solid var(--secondary); padding: 1rem; margin-bottom: 1rem; background: #F8FAFC; border-radius: 4px;">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <div>
                                    ...
                                    <a href="${pageContext.request.contextPath}/faculty/announcements?action=delete&id=${a.announcementId}" class="btn btn-danger btn-sm" onclick="return confirm('Delete this announcement?');"><i class="bi bi-trash"></i> Delete</a>
                                </div>
                            </div>
