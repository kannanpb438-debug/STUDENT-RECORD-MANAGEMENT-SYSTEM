...
<head>
    <meta charset="UTF-8">
    <title>Faculty Timetable - SRMS</title>
    ...
    <div class="app-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-item">
                    <a href="${pageContext.request.contextPath}/faculty/timetable" class="sidebar-link active">
        ...
        <div class="main-wrapper">
            <div class="top-navbar">
                <div class="page-title">Personal Teaching Schedule</div>
            ...
            <div class="content-body">
                <div class="card table-card">
                    <div class="table-header-bar">
                        <div class="table-title"><i class="bi bi-calendar-week me-2"></i> Weekly Schedule</div>
                    </div>
                            ...
                            <tbody>
                                <c:choose>
                                    <c:when test="${empty timetable}">
                                        <tr><td colspan="7" class="text-center text-muted">No timetable slots assigned yet.</td></tr>
                                    </c:when>
                                    <c:otherwise>
                                        <c:forEach var="t" items="${timetable}">
                                            <tr>
                                                ...
                                                <td>${t.subjectName}</td>
                                                <td><span class="badge-pill badge-primary">${t.deptName}</span></td>
                                                <td>S${t.semester}</td>
